...
int main()
{
    ...
    search_server.AddDocument(0, "white cat and fancy collar"s, DocumentStatus::ACTUAL, { 8, -3 });
    ...
    search_server.AddDocument(3, "groomed  starling yevgeny"s, DocumentStatus::BANNED, { 9 });
