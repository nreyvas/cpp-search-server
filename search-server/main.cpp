    ...
    const vector<int>& ratings)
{
    ...
    {
        cout << "Error while adding a document "s << document_id << ": "s << e.what() << endl;
    }
}
...
void MatchDocuments(const SearchServer& search_server, const string& query)
{
    try
    {
        cout << "Matching documents for query: "s << query << endl;
...
int main() {
    ...
    AddDocument(search_server, 1, "fluffy dog and fancy collar"s, DocumentStatus::ACTUAL, { 1, 2 });
    AddDocument(search_server, -1, "fluffy dog and fancy collar"s, DocumentStatus::ACTUAL, { 1, 2 });
    AddDocument(search_server, 3, "big dog star\x12ling yevgeniy"s, DocumentStatus::ACTUAL, { 1, 3, 2 });
    AddDocument(search_server, 4, "big dog starling yevgeniy"s, DocumentStatus::ACTUAL, { 1, 1, 1 });
    ...
    MatchDocuments(search_server, "fancy -cat"s);
    MatchDocuments(search_server, "fancy --cat"s);
